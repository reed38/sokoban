...
# 11 "src/levelLoader.c" 2

# 1 "include/levelLoader.h" 1
# 17 "include/levelLoader.h"
...
# 38 "include/levelLoader.h"
    extern Level *levelsNode;
# 51 "include/levelLoader.h"
...
# 13 "src/levelLoader.c" 2
    ...
    Level *levelsNode = 
# 18 "src/levelLoader.c" 3 4
                       ((void *)0)
# 18 "src/levelLoader.c"
                           ;
    ...
    void listeAffiche(void)
    {
     ...
     if (
# 42 "src/levelLoader.c" 3 4
        ((void *)0) 
# 42 "src/levelLoader.c"
             == ptrFollow)
      printf("Liste vide!");
     else
      printf("Contenu de la liste : ");
     while (
# 46 "src/levelLoader.c" 3 4
           ((void *)0) 
# 46 "src/levelLoader.c"
                != ptrFollow) {
...
# 74 "src/levelLoader.c"
    ...
    {
     FILE *levelsFile = 
# 85 "src/levelLoader.c" 3 4
                       ((void *)0)
# 85 "src/levelLoader.c"
                           ;

     int lineLen = 0;
     long unsigned int lineSize = 0;
     char *lineBuffer = 
# 89 "src/levelLoader.c" 3 4
                       ((void *)0)
# 89 "src/levelLoader.c"
                           ;

     levelsFile = fopen(location, "r");
     if (levelsFile == 
# 92 "src/levelLoader.c" 3 4
                      ((void *)0)
# 92 "src/levelLoader.c"
                          )
     {
      fprintf(
# 94 "src/levelLoader.c" 3 4
             stderr
# 94 "src/levelLoader.c"
     ...
     if(lineBuffer != 
# 104 "src/levelLoader.c" 3 4
                     ((void *)0)
# 104 "src/levelLoader.c"
                         )
     {
      free(lineBuffer);
        lineBuffer=
# 107 "src/levelLoader.c" 3 4
                  ((void *)0)
# 107 "src/levelLoader.c"
                      ;
     }

     fclose(levelsFile);
    }
# 121 "src/levelLoader.c"
    static void parseLine(char *line)
    {
     static Level *currentLevel = 
# 123 "src/levelLoader.c" 3 4
                                 ((void *)0)
# 123 "src/levelLoader.c"
                                     ;


     if(strchr(line, '\r') != 
# 126 "src/levelLoader.c" 3 4
                             ((void *)0)
# 126 "src/levelLoader.c"
                                 )
      line[strcspn(line, "\r")] = '\0';
     if(strchr(line, '\n') != 
# 128 "src/levelLoader.c" 3 4
                             ((void *)0)
# 128 "src/levelLoader.c"
                                 )
      line[strcspn(line, "\n")] = '\0';

     if(startWith(";LEVEL", line))
     {
     ...
     else if(startWith(";SUCCESS", line))
     {
     ...
     {
      if(levelsNode == 
# 150 "src/levelLoader.c" 3 4
                      ((void *)0)
# 150 "src/levelLoader.c"
                          )
       return;
    ...
    static Level* insertLevel(unsigned int levelNumber)
    {
     ...
     if(lv == 
# 166 "src/levelLoader.c" 3 4
             ((void *)0)
# 166 "src/levelLoader.c"
                 ) {
      fprintf(
# 167 "src/levelLoader.c" 3 4
             stderr
# 167 "src/levelLoader.c"
     ...
     lv->author = 
# 172 "src/levelLoader.c" 3 4
                 ((void *)0)
# 172 "src/levelLoader.c"
                     ;
     lv->comment = 
# 173 "src/levelLoader.c" 3 4
                  ((void *)0)
# 173 "src/levelLoader.c"
                      ;
     lv->success = 0;
     lv->map = 
# 175 "src/levelLoader.c" 3 4
              ((void *)0)
# 175 "src/levelLoader.c"
                  ;
     lv->numberLines = 0;
     lv->nextLevel = 
# 177 "src/levelLoader.c" 3 4
                    ((void *)0)
# 177 "src/levelLoader.c"
                        ;

     if (levelsNode == 
# 179 "src/levelLoader.c" 3 4
                      ((void *)0)
# 179 "src/levelLoader.c"
                          ) {
      levelsNode = lv;
      return lv;
     }
     ...
     while (ptrFollow->nextLevel != 
# 186 "src/levelLoader.c" 3 4
                                   ((void *)0)
# 186 "src/levelLoader.c"
                                       ) {
      ptrFollow = ptrFollow->nextLevel;
     }

     ptrFollow->nextLevel = lv;

     return lv;
    }
# 202 "src/levelLoader.c"
    static void insertInfo(char **member, char *args)
    {
     *member = (char *) malloc((strlen(args) + 1) * sizeof(char));
     if(*member == 
# 205 "src/levelLoader.c" 3 4
                  ((void *)0)
# 205 "src/levelLoader.c"
                      )
     {
      fprintf(
# 207 "src/levelLoader.c" 3 4
             stderr
# 207 "src/levelLoader.c"
                   , "Mémoire insuffisante !\n");
      exit(1);
     }
     strcpy(*member, args);
    }
# 222 "src/levelLoader.c"
    static void generateMap(char ***map, unsigned int *numberLines, char *line)
    {
     ...
     if(newMap == 
# 232 "src/levelLoader.c" 3 4
                 ((void *)0)
# 232 "src/levelLoader.c"
                     )
     {
      fprintf(
# 234 "src/levelLoader.c" 3 4
             stderr
# 234 "src/levelLoader.c"
                   , "Mémoire insuffisante !\n");
      exit(1);
     }

     newMap[*numberLines] = (char *) malloc((strlen(line) + 1) * sizeof(char));
     if(newMap[*numberLines] == 
# 239 "src/levelLoader.c" 3 4
                               ((void *)0)
# 239 "src/levelLoader.c"
                                   )
     {
      fprintf(
# 241 "src/levelLoader.c" 3 4
             stderr
# 241 "src/levelLoader.c"
                   , "Mémoire insuffisante !\n");
      exit(1);
     }
